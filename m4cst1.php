...
<label >Day:</label><input type="text" name="day" value="<?php echo $_SESSION['MU7D'];?>" readonly>
<label >Time:</label><input type="text" name="time" value="<?php echo $_SESSION['MU7T'];?>" readonly>
