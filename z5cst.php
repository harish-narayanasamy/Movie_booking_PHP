...
<label >Name:</label><input type="text" name="movie" value="<?php echo $_SESSION['M1N'];?>" readonly>
<label >Day:</label><input type="text" name="day" value="<?php echo $_SESSION['Z5D'];?>" readonly>
<label >Time:</label><input type="text" name="time" value="<?php echo $_SESSION['Z5T'];?>" readonly>
<br>
