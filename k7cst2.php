...
<label >Day:</label><input type="text" name="day" value="<?php echo $_SESSION['K7D'];?>" readonly>
<label >Time:</label><input type="text" name="time" value="<?php echo $_SESSION['K7T'];?>" readonly>
<br>
