...
<label >Day:</label><input type="text" name="day" value="<?php echo $_SESSION['Z4D'];?>" readonly>
<label >Time:</label><input type="text" name="time" value="<?php echo $_SESSION['Z4T'];?>" readonly>
<br>
