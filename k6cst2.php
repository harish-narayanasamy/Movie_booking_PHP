...
<label >Day:</label><input type="text" name="day" value="<?php echo $_SESSION['K6D'];?>" readonly>
<label >Time:</label><input type="text" name="time" value="<?php echo $_SESSION['K6T'];?>" readonly>
<br>
