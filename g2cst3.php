...
<label >Day:</label><input type="text" name="day" value="<?php echo $_SESSION['G4D'];?>" readonly>
<label >Time:</label><input type="text" name="time" value="<?php echo $_SESSION['G4T'];?>" readonly>
