...
<label>Day:</label><input type="text" name="day" value="<?php echo $_SESSION['G1D'];?>" readonly>
<label >Time:</label><input type="text" name="time" value="<?php echo $_SESSION['G1T'];?>" readonly>
