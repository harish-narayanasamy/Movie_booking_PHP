...
<label >Name:</label><input type="text" name="movie" value="<?php echo $_SESSION['M3N'];?>" readonly>
<label >Name:</label><input type="text" name="day" value="<?php echo $_SESSION['K4D'];?>" readonly>
<label >Name:</label><input type="text" name="time" value="<?php echo $_SESSION['K4T'];?>" readonly>
<br>
