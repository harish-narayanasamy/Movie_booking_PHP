...
<label >Name:</label><input type="text" name="movie" value="<?php echo $_SESSION['M4N'];?>" readonly>
<label >Day:</label><input type="text" name="day" value="<?php echo $_SESSION['G6D'];?>" readonly>
<label >Time:</label><input type="text" name="time" value="<?php echo $_SESSION['G6T'];?>" readonly>
