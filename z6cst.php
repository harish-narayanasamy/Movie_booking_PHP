...
<label >Day:</label><input type="text" name="day" value="<?php echo $_SESSION['Z6D'];?>" readonly>
<label >Time:</label><input type="text" name="time" value="<?php echo $_SESSION['Z6T'];?>" readonly>
<br>
