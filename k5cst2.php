...
<label >Day:</label><input type="text" name="day" value="<?php echo $_SESSION['K5D'];?>" readonly>
<label >Time:</label><input type="text" name="time" value="<?php echo $_SESSION['K5T'];?>" readonly>
<br>
